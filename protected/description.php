...
<head>
      ...
      <title>Leírás | Portfólió Weblap</title>
      ...
      <div class="wrapper">
                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-8">
                                    ...
                                    <h3 class="wow fadeInUp" data-wow-delay="1s">Leírás</h3><br>
                                    <p class="wow fadeInUp" data-wow-delay="1.2s">Ez az oldal azért készült el, hogy megfeleljen a webprog2 beadandónak.</p>
									<p class="wow fadeInUp" data-wow-delay="1.4s">A képek itt is szintén kattinthatóak.</p>
                              </div>
                        </div>
                  </div>
            </div>
            ...
            <div class="container-fluid">
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-4 project project1 wow fadeInUp" data-wow-delay="1.4s" onclick="location.href='images.php'"></div>
                  </div>

                  <div class="whitespace"></div>

                  <div class="row">
                        <div class="col-lg-6 project project2 wow fadeInUp" onclick="location.href='images.php'"></div>
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-4 project project3 wow fadeInUp" onclick="location.href='images.php'"></div>
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-5 project project4 wow fadeInUp" onclick="location.href='images.php'"></div>
